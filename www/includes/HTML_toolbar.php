...
class mosToolBar {
	...
	*/
	function custom( $task='', $icon=NULL, $iconOver='', $alt='', $listSelect=true ) {
		if ($listSelect) {
			$href = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, faça uma seleção da lista $alt');}else{submitbutton('$task')}";
		} else {
	...
	*/
	function publishList( $task='publish', $alt=_CMN_PUBLISHED ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, faça uma seleção da lista para publicar'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function unpublishList( $task='unpublish', $alt=_CMN_UNPUBLISHED ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, faça uma seleção da lista para despublicar'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function archiveList( $task='archive', $alt=_CMN_ARCHIVE ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, faça uma seleção da lista para arquivar'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function unarchiveList( $task='unarchive', $alt=_CMN_UNARCHIVE ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione uma notícia para desarquivar'); } else {submitbutton('<?php echo $task;?>', '');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
	...
	*/
	function deleteList( $msg='', $task='remove', $alt=_CMN_DELETE ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para pagar'); } else if (confirm('Are you sure you want to delete selected items. <?php echo $msg;?>')){ submitbutton('<?php echo $task;?>');}" >
				<?php echo $image; ?></a>
		</td>
		<?php
	}
