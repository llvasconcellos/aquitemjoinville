	...
	?>
		...
		<tr>
			...
			?>
			 ...
			 <td valign="top">
			* Isto vai <strong><font color="#FF0000">remover definitivamente</font></strong> <br />os dados do sistema*
			<br /><br /><br />
			<div style="border: 1px dotted gray; width: 70px; padding: 10px; margin-left: 50px;">
			<a class="toolbar" href="javascript:if (confirm('Tem certeza que deseja apagar os itens listados? \nIsto irá remover definitivamente os dados do sistema.')){ submitbutton('delete');}" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('remove','','images/delete_f2.png',1);">
