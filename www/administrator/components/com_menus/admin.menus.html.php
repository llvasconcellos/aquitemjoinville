...
class HTML_menusections {
	...
	function showMenusections( $rows, $pageNav, $search, $levellist, $menutype, $option ) {
		...
		<tr>
			<th class="menus">
			Administrar menus <small><small>[ <?php echo $menutype;?> ]</small></small>
			</th>
			<td nowrap="nowrap">
			Nível Máximo
			</td>
	...
	*/
	function addMenuItem( &$cid, $menutype, $option, $types_content, $types_component, $types_link, $types_other, $types_submit ) {
		...
		<tr>
			...
			* Nota: Alguns tipos de menu aparecem em mais do que um grupo, porém continuam a ser o mesmo tipo de menu.
			</td>
		</tr>
		</table>
	...
	*/
	function moveMenu( $option, $cid, $MenuList, $items, $menutype  ) {
		...
		<tr>
			...
			<strong>
			Os itens de menu que serão movidos:
			</strong>
			<br />
			<ol>
			<?php
	...
	*/
	function copyMenu( $option, $cid, $MenuList, $items, $menutype  ) {
		...
		<tr>
			...
			<td align="left" valign="top">
			<strong>
			Os itens de menu que serão copiados:
			</strong>
			<br />
			<ol>
			<?php
