...
class content_section_menu_html {
	...
	function editSection( &$menu, &$lists, &$params, $option ) {
		...
		<tr>
			<th>
			<?php echo $menu->id ? 'Editar' : 'Adicionar';?> Tabela - Conteúdo de Seção
			</th>
		</tr>
		</table>
		...
		<tr valign="top">
			<td width="60%">
				...
				<tr>
					...
					<?php
					if ( !$menu->id ) {
						echo mosToolTip( 'Se você deixar este em branco o nome da Seção será automaticamente usado' );
					}
					?>
					</td>
				</tr>
				<tr>
					<td align="right" valign="top">Seção:</td>
					<td colspan="2">
				...
				<tr>
					<td align="right">Nível de Item:</td>
					<td colspan="2">
