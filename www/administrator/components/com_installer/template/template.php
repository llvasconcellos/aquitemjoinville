...
HTML_installer::showInstallForm( 'Instalar novo Tema  <small><small>[ ' . ($client == 'admin' ? 'Administração' : 'Site') .' ]</small></small>',
	$option, 'template', $client, $userfile,
	'<a href="index2.php?option=com_templates&client='.$client.'">Voltar ao administrador de temas</a>'
);
?>
<table class="content">
<?php
