...
class HTML_templates {
	...
	*/
	function showTemplates( &$rows, &$pageNav, $option, $client ) {
		...
		<tr>
			<th class="templates">
			Administrar Temas <small><small>[ <?php echo $client == 'admin' ? 'Administrator' : 'Site';?> ]</small></small>
			</th>
	...
	*/
	function editTemplateSource( $template, &$content, $option, $client ) {
		...
		<tr>
			<td width="290"><table class="adminheading"><tr><th class="templates">Editor de Tema HTML</th></tr></table></td>
			<td width="220">
				<span class="componentheading">index.php está :
				<b><?php echo is_writable($template_path) ? '<font color="green"> Permissão para escrita</font>' : '<font color="red"> Sem permissão para escrita</font>' ?></b>
				</span>
			</td>
<?php
...
?>
	...
	*/
	function editCSSSource( $template, &$content, $option, $client ) {
		...
		<table cellpadding="1" cellspacing="1" border="0" width="100%">
		<tr>
			<td width="280"><table class="adminheading"><tr><th class="templates">Editor de tema CSS </th></tr></table></td>
			<td width="260">
				<span class="componentheading">template_css.css está :
				<b><?php echo is_writable($css_path) ? '<font color="green"> Permissão para escrita</font>' : '<font color="red">Sem permissão para escrita</font>' ?></b>
				</span>
			</td>
<?php
	...
	*/
	function assignTemplate( $template, &$menulist, $option ) {
		...
		<tr>
			...
			Assistente modelo <?php echo $template; ?> para artigos de menu
			</th>
		</tr>
		<tr>
