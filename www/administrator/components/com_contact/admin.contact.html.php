...
class HTML_contact {
		...
		for ($i=0, $n=count($rows); $i < $n; $i++) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				if ( $row->checked_out && ( $row->checked_out != $my->id ) ) {
					...
					?>
					<a href="<?php echo $link; ?>" title="Editar Contato">
					<?php echo $row->name; ?>
					</a>
					<?php
				}
				...
				<td>
				<a href="<?php echo $row->user_link; ?>" title="Editar Usuário">
				<?php echo $row->user; ?>
				</a>
				</td>
			</tr>
	...
	function editContact( &$row, &$lists, $option, &$params ) {
		...
		function submitbutton(pressbutton) {
			...
			// do field validation
			if ( form.name.value == "" ) {
				alert( "Você tem que informar um nome." );
		...
		<tr>
			...
			<td width="40%" valign="top">
				...
				<tr>
					...
					document.write('<img src=' + jsimg + ' name="imagelib" width="100" height="100" border="2" alt="Pré-visualizar" />');
					</script>
					</td>
				</tr>
				</table>
				...
				<tr>
					<td>
					Estes parâmetros controlam o que vê quando clicar para exibir um item de Contato<br />
					<br /><br />
					</td>
				</tr>
				<tr>
