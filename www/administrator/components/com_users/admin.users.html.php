...
class HTML_users {
	...
	function edituser( &$row, &$contact, &$lists, $option, $uid, &$params ) {
		...
		<tr>
			<th class="user">
			Usuário: <small><?php echo $row->id ? 'Editar' : 'Adicionar';?></small>
			</th>
		</tr>
		</table>
				...
				if ( !$contact ) {
					...
					if ($contact[0]->image) {
						...
						<tr>
							<td></td>
							<td valign="top">
							<img src="<?php echo $mosConfig_live_site;?>/images/stories/<?php echo $contact[0]->image; ?>" align="middle" alt="Contato" />
							</td>
						</tr>
						<?php
					}
