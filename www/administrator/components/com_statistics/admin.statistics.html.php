...
class HTML_statistics {
	function show( &$browsers, &$platforms, $tldomains, $bstats, $pstats, $dstats, $sorts, $option ) {
		...
		<tr>
			<th class="browser">Navegador, Sistemas Operacionais, Domínio</th>
		</tr>
		</table>
		...
		<tr>
			<th align="left">&nbsp;Navegadores <?php echo $sorts['b_agent'];?></th>
			<th>&nbsp;</th>
			<th width="100" align="left">% <?php echo $sorts['b_hits'];?></th>
			<th width="100" align="left">Qtd.</th>
		</tr>
		<?php
		$c = 1;
		...
		<?php
		$tabs->endTab();
		$tabs->startTab("Sistemas","os-page");
		?>
		<table class="adminlist">
		<tr>
			<th align="left">&nbsp;Sistema Operacional <?php echo $sorts['o_agent'];?></th>
			<th>&nbsp;</th>
		...
		<?php
		$tabs->endTab();
		$tabs->startTab("Domínios","domain-page");
		?>
		<table class="adminlist">
		<tr>
			<th align="left">&nbsp;Domínio <?php echo $sorts['d_agent'];?></th>
			<th>&nbsp;</th>
	...
	function pageImpressions( &$rows, $pageNav, $option, $task ) {
		...
		<tr>
			<th width="100%" class="impressions">Estatísticas de Páginas Visualizadas</th>
		</tr>
		</table>
		...
		<tr>
			...
			<th align="center" nowrap="nowrap">Visualizações</th>
		</tr>
		<?php
		...
		<tr>
			<th class="searchtext">
				...
				<span class="componentheading">Status:
					<?php echo $mainframe->getCfg( 'enable_log_searches' ) ? '<b><font color="green">Ativado</font></b>' : '<b><font color="red">Desativado</font></b>' ?>
				</span>
			</th>
			<td align="right">
				<?php
