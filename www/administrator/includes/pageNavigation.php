...
class mosPageNav {
	...
	*/
	function getPagesCounter() {
		...
		if ($this->total > 0) {
			$html .= "\nResultados " . $from_result . " - " . $to_result . " de " . $this->total;
		} else {
			$html .= "\nSem registros.";
		}
		return $html;
	...
	*/
	function getPagesLinks() {
		...
		if ($this_page > 1) {
			...
			$html .= "\n<a href=\"#beg\" class=\"pagenav\" title=\"primeira página\" onclick=\"javascript: document.adminForm.limitstart.value=0; document.adminForm.submit();return false;\"><< Início </a>";
			$html .= "\n<a href=\"#prev\" class=\"pagenav\" title=\"página anterior\" onclick=\"javascript: document.adminForm.limitstart.value=$page; document.adminForm.submit();return false;\">< Anterior | </a>";
		} else {
			$html .= "\n<span class=\"pagenav\"><< Início</span>";
		...
		if ($this_page < $total_pages) {
			...
			$html .= "\n<a href=\"#next\" class=\"pagenav\" title=\"próxima página\" onclick=\"javascript: document.adminForm.limitstart.value=$page; document.adminForm.submit();return false;\"> | Seguinte ></a>";
			$html .= "\n<a href=\"#end\" class=\"pagenav\" title=\"última página\" onclick=\"javascript: document.adminForm.limitstart.value=$end_page; document.adminForm.submit();return false;\"> Final >></a>";
		} else {
			$html .= "\n<span class=\"pagenav\"> | Seguinte ></span>";
			$html .= "\n<span class=\"pagenav\">Final >></span>";
		}
		return $html;
	}
	...
	function getListFooter() {
		...
		$html .= '</th></tr><tr>';
		$html .= '<td nowrap="nowrap" width="48%" align="right">Listar</td>';
...
* @return string
*/
	function orderUpIcon( $i, $condition=true, $task='orderup', $alt='Para cima' ) {
...
* @return string
*/
	function orderDownIcon( $i, $n, $condition=true, $task='orderdown', $alt='Para Baixo' ) {
