...
class mosMenuBar {
	...
	*/
	function custom( $task='', $icon='', $iconOver='', $alt='', $listSelect=true ) {
		...
		if ($listSelect) {
			$href = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para $alt');}else{submitbutton('$task')}";
		} else {
	...
	* @param string An override for the alt text
	*/
	function addNewX( $task='new', $alt='Novo' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'new_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
	...
	* @param string An override for the alt text
	*/
	function publish( $task='publish', $alt='Publicar' ) {
	...
	*/
	function publishList( $task='publish', $alt='Publicar' ) {
		...
		?>
	 	<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para publicar'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
	 	<?php
	...
	* @param string An override for the alt text
	*/
	function makeDefault( $task='default', $alt='Padrão' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para definir como padrão'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function assign( $task='assign', $alt='Atribuir' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para atribuir'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function unpublish( $task='unpublish', $alt='Despublicar' ) {
	...
	*/
	function unpublishList( $task='unpublish', $alt='Despublicar' ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para despublicar'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function archiveList( $task='archive', $alt='Arquivar' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'archive_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para arquivar'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function unarchiveList( $task='unarchive', $alt='Desarquivar' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'unarchive_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para desarquivar'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	*/
	function editList( $task='edit', $alt='Editar' ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para editar'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function editListX( $task='edit', $alt='Editar' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'edit_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para editar'); } else {hideMainMenu();submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function editHtml( $task='edit_source', $alt='Editar&nbsp;HTML' ) {
	...
	* @param string An override for the alt text
	*/
	function editHtmlX( $task='edit_source', $alt='Editar&nbsp;HTML' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'html_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um artigo da lista para editar'); } else {hideMainMenu();submitbutton('<?php echo $task;?>', '');}"">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function editCss( $task='edit_css', $alt='Editar&nbsp;CSS' ) {
	...
	* @param string An override for the alt text
	*/
	function editCssX( $task='edit_css', $alt='Editar&nbsp;CSS' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'css_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para editar'); } else {hideMainMenu();submitbutton('<?php echo $task;?>', '');}">
	...
	*/
	function deleteList( $msg='', $task='remove', $alt='Deletar' ) {
		...
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para deletar'); } else if (confirm('Você tem certeza que deseja deletar o item selecionado? <?php echo $msg;?>')){ submitbutton('<?php echo $task;?>');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	* @param string An override for the alt text
	*/
	function deleteListX( $msg='', $task='remove', $alt='Lixeira' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'delete_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para deletar'); } else if (confirm('Você tem certeza que deseja deletar o item selecionado? <?php echo $msg;?>')){ hideMainMenu();submitbutton('<?php echo $task;?>');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	/**
	* Escreva um botão de lixo que moverá artigos para Administrador de Lixo
	*/
	function trash( $task='remove', $alt='Lixeira', $check=true ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'delete_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		
		if ( $check ) {
			$js = "javascript:if (document.adminForm.boxchecked.value == 0){ alert('Por favor, selecione um item da lista para enviar a lixeira'); } else { submitbutton('$task');}";
		} else {
	...
	*/
	function preview( $popup='', $updateEditors=false ) {
		global $database;
		$image2 = mosAdminMenus::ImageCheckAdmin( 'preview_f2.png', '/administrator/images/', NULL, NULL, 'Visualizar', 'visualizar', 1, 'middle', 'Pré-visualizar' );
	...
	*/
	function help( $ref, $com=false ) {
		...
		$image2 	= mosAdminMenus::ImageCheckAdmin( 'help_f2.png', '/administrator/images/', NULL, NULL, 'Ajuda', 'help', 1, 'middle', 'Ajuda' );
	...
	* @param string An override for the alt text
	*/
	function apply( $task='apply', $alt='Aplicar' ) {
	...
	*/
	function media_manager( $directory='', $alt='Enviar' ) {
		global $database, $mainframe;
		
		$cur_template = $mainframe->getTemplate();
		
		$image2 = mosAdminMenus::ImageCheckAdmin( 'upload_f2.png', '/administrator/images/', NULL, NULL, 'Enviar Imagem', 'uploadPic', 1 );
		?>
		<td>
